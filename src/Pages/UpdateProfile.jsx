					...
					<div className='mt-2 sm:mx-auto sm:w-full sm:max-w-sm'>
						<form className='space-y-6'>
							<div>
								...
								<div className='mt-1'>
									<input id='name' name='name' type='name' defaultValue={doctor.name} autoComplete='name' required className='block w-full rounded-md p-2 border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6' />
								</div>
							</div>
							<div>
							...
							<div>
								...
								<div className='mt-1'>
									<select id='countries' className='block w-full rounded-md p-2 border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6'>
							...
							<div>
								<button type='submit' className='flex w-full justify-center  rounded-md bg-blue-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600' onClick={handleUpdate}>
									Update Now
								</button>
							</div>
						</form>
					...
					<div className='mt-2 sm:mx-auto sm:w-full sm:max-w-sm'>
						<form className='space-y-6'>
							<div>
								...
								<div className='mt-1'>
									<input id='name' name='name' defaultValue={patient.name} type='name' autoComplete='name' required className='block w-full rounded-md p-2 border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6' />
								</div>
							</div>
							...
							<div>
								...
								<div className='mt-1'>
									<input id='age' name='age' type='age' defaultValue={patient.age} autoComplete='current-age' required className='block w-full rounded-md p-2 border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6' />
								</div>
							</div>
