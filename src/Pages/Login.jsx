			...
			{isLogin ? (
				<div className='flex min-h-full flex-1 flex-col justify-center px-6 py-24 lg:px-8 '>
					<div className='sm:mx-auto sm:w-full sm:max-w-sm'>
						...
						<h2 className='mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900'>{isDoctor ? 'Speaker Login' : 'Listener Login'}</h2>
					</div>
					...
					<div className='mt-10 sm:mx-auto sm:w-full sm:max-w-sm'>
						<form className='space-y-6' action='/' method='POST' id='loginForm'>
							...
							<div>
								<button type='submit' className='flex w-full justify-center rounded-md bg-blue-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600' onClick={handleLogin}>
									Log in
								</button>
							</div>
						</form>
						...
						<p className='mt-10 text-center text-sm text-gray-500'>
							Not a member?{' '}
							<Link className='font-semibold leading-6 text-blue-600 hover:text-blue-500' onClick={() => setLogin(false)}>
								Sign up
							</Link>
						</p>
					</div>
				...
				<div className='flex min-h-full flex-1 flex-col justify-center px-6 py-24 lg:px-8'>
					<div className='sm:mx-auto sm:w-full sm:max-w-sm'>
						<img className='mx-auto h-10 w-auto' src='./logo.png' alt='Your Company' />
						<h2 className='mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900'>{isDoctor ? 'Speaker Sign Up' : 'Listener Sign Up'}</h2>
					</div>
					...
					<div className='mt-10 sm:mx-auto sm:w-full sm:max-w-sm signupForm'>
						<form className='space-y-6' action='/' method='POST'>
							...
							<div>
								<button type='submit' className='flex w-full justify-center rounded-md bg-blue-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600' onClick={handleSignup}>
									Sign up
								</button>
							</div>
						</form>
						...
						<p className='mt-10 text-center text-sm text-gray-500'>
							Already a Member?{' '}
							<Link className='font-semibold leading-6 text-blue-600 hover:text-blue-500' onClick={() => setLogin(true)}>
								Log in
							</Link>
						</p>
					</div>
